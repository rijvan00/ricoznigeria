...
const Section7: FunctionComponent = () => {
  return (
    <section className="self-stretch bg-darkslategray-300 flex flex-col items-end justify-start pt-[119px] px-[99px] pb-[164px] box-border bg-[url('/public/section4@3x.png')] bg-cover bg-no-repeat bg-[top] min-h-[381px] max-w-full shrink-0 text-center text-21xl text-white font-playfair-display mq450:pt-[77px] mq450:pb-[107px] mq450:box-border mq800:pl-6 mq800:pr-6 mq800:box-border mq1325:pl-[49px] mq1325:pr-[49px] mq1325:box-border">
