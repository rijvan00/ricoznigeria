...
const Section4: FunctionComponent = () => {
  return (
    <section className="ml-[-4px] mb-[63px] self-stretch bg-darkslategray-300 flex flex-row items-start justify-end py-[98px] px-[120px] box-border bg-[url('/public/section3@3x.png')] bg-cover bg-no-repeat bg-[top] min-h-[284px] max-w-full shrink-0 text-left text-13xl text-white font-poppins mq800:pl-[30px] mq800:pr-[30px] mq800:box-border mq1325:pl-[60px] mq1325:pr-[60px] mq1325:box-border">
