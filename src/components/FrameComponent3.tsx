...
const FrameComponent31: FunctionComponent = () => {
  return (
    <section className="self-stretch flex flex-row items-start justify-center pt-0 px-5 pb-[60px] box-border max-w-full text-center text-11xl text-darkslategray-100 font-playfair-display mq825:pb-[39px] mq825:box-border">
      <div className="w-[1170px] flex flex-col items-end justify-start gap-[43.6px] max-w-full mq825:gap-[22px]">
        <div className="self-stretch flex flex-row items-start justify-center py-0 px-5 box-border max-w-full">
          <div className="w-[999.4px] flex flex-col items-start justify-start gap-[27px] max-w-full">
            <div className="self-stretch flex flex-row items-start justify-center py-0 pr-[21px] pl-5">
              <h2 className="m-0 w-[178px] relative text-inherit leading-[40px] capitalize font-bold font-inherit flex items-center justify-center mq825:text-5xl mq825:leading-[32px] mq450:text-lg mq450:leading-[24px]">
                our services
              </h2>
            </div>
        ...
        <div className="self-stretch flex flex-row items-start justify-between pt-0 px-[43px] pb-[15px] gap-[20px] text-5xl lg:flex-wrap lg:justify-center lg:pl-[21px] lg:pr-[21px] lg:box-border">
